...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { description: @register.description, email: @register.email, name: @register.name, phone: @register.phone }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { description: @register.description, email: @register.email, name: @register.name, phone: @register.phone }
    assert_redirected_to register_path(assigns(:register))
  end
